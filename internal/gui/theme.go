...
type EllipticTheme struct{}

func (EllipticTheme) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	switch c {
...
func (EllipticTheme) Font(s fyne.TextStyle) fyne.Resource {
	if s.Monospace {
...
func (EllipticTheme) Icon(n fyne.ThemeIconName) fyne.Resource {
	return theme.DefaultTheme().Icon(n)
}

func (EllipticTheme) Size(s fyne.ThemeSizeName) float32 {
	switch s {
